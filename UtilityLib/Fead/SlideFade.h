...
namespace Utility
{
	...
	public:
		 ...
		 */
		SlideFade(ID3D11DeviceContext * argContext, eFadeType argFadeType, Math::Vector2 argWindowSize, std::shared_ptr<Texture> argTexture);
		~SlideFade();
